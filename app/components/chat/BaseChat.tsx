    ...
    const baseChat = (
      ...
      >
        ...
        <div className="flex-1 flex flex-col">
          {/* Tab Header */}
          <div className="flex border-b border-bolt-elements-borderColor bg-bolt-elements-background">
            <button
              onClick={() => setActiveTab('main')}
              className={classNames(
                'px-4 py-2 text-sm font-medium transition-colors duration-200',
                activeTab === 'main'
                  ? 'text-bolt-elements-textPrimary border-b-2 border-purple-500'
          ...
          <div className="flex-1 overflow-hidden relative">
            {/* Main Tab (Chat & Workbench) */}
            <div
              className={classNames(
                'absolute inset-0 w-full h-full transition-all duration-300 transform',
                activeTab === 'main' ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0',
              )}
            >
            ...
            <div
              className={classNames(
                'absolute inset-0 w-full h-full transition-all duration-300 transform',
                activeTab === 'preview' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0',
              )}
            >
              <iframe
